...
-- With animations: `MiniAnimate` executes a scroll animation by doing multiple mini-scrolls, so we have to wait for it to finish, disable scroll, center, and then enable again
